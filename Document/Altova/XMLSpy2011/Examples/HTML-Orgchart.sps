...
<structure version="10" xsltversion="1" htmlmode="strict" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="UTF-8" encodingpdf="UTF-8" useimportschema="1" embed-images="1" pastemode="xml">
	<parameters/>
	<schemasources>
		<namespaces>
		...
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="HTML-OrgChart.xsd" workingxmlfile="Html-OrgChart.xml" templatexmlfile="Html-OrgChart.xml">
