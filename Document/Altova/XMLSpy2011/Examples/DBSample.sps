...
<structure version="9" htmlmode="strict" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="UTF-8" encodingpdf="UTF-8" useimportschema="1" embed-images="1" pastemode="xml">
	<parameters/>
	<schemasources>
		<namespaces/>
		<schemasources>
			<dbschemasource name="DB" main="1">
				<xmltablesupport/>
				<textstateicons/>
				<database_connection database_kind="MS Access" import_kind="ADO" version="04.00.0000" name="altova" active="1">
					<properties>
