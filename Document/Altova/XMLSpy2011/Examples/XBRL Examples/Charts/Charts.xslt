...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:nanonull="http://www.altova.com/nanonull" xmlns:ref="http://www.xbrl.org/2006/ref" xmlns:us-gaap="http://xbrl.us/us-gaap/2008-03-31" xmlns:us-gaap-all="http://xbrl.us/us-gaap-all/2008-03-31" xmlns:us-gaap-std="http://xbrl.us/us-gaap-std/2008-03-31" xmlns:us-roles="http://xbrl.us/us-roles/2008-03-31" xmlns:us-types="http://xbrl.us/us-types/2008-03-31" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrldt="http://xbrl.org/2005/xbrldt" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xl="http://www.xbrl.org/2003/XLink" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:altova="http://www.altova.com" exclude-result-prefixes="#all">
 ...
 .xbrl-cell-row-title-level-10 { padding-left:2.5cm;
			...
			<body>
				...
				<img style="height:3.47in; width:6.31in; " title="Total Assets">
					...
					<xsl:variable name="altova:nodeXAxisCategories">
						<xsl:for-each select="$XBRL">
							<xsl:for-each select="altova:distinct-nodes( $altova:XBRL-xbrl-contexts/xbrli:period[ exists( xbrli:instant ) ][ year-from-date(xbrli:instant) ge 2007 ] )">
								...
								<xsl:variable name="altova:xbrl-contexts-201522752" select="$altova:XBRL-xbrl-contexts[ fn:deep-equal( xbrli:period, current() ) ]"/>
								<altova:Pos altova:sLabel="{if (xbrli:instant) then xbrli:instant else if (xbrli:startDate) then concat(xbrli:startDate, ' - ', xbrli:endDate) else if (xbrli:forever) then 'forever' else '?'}">
									<xsl:for-each select="$altova:xbrl-contexts-201522752">
					...
					<xsl:variable name="altova:sChartFileName" select="concat('SV', $SV_OutputFormat, 'GeneratedChart', altovaext:generate-auto-number( 'sv_chart', 1, 1, '' ), '.png')"/>
					<xsl:attribute name="alt" select="'chart'"/>
					<xsl:attribute name="src" select="$altova:sChartFileName, altovaext:save-chart-image( $altova:nodeChart, $altova:sChartFileName, $altova:nChartWidthPx, $altova:nChartHeightPx  )"/>
				</img>
				<br/>
				<span style="font-style:italic; ">
					<xsl:text>Demonstates use of a line graph. The periods are of type &apos;instant&apos;, and their default labeling reflects this.</xsl:text>
				</span>
				<br class="altova-page-break" clear="all"/>
				<h1 style="border-bottom:3px solid #009DC3; ">
					<altova:marker altova:name="toc">
					...
					<xsl:variable name="altova:nodeXAxisSeries">
						<xsl:for-each select="$XBRL">
							<altova:Pos altova:sLabel="Net income">
								<xsl:variable name="altova:xbrl-contexts-201522752" select="$altova:XBRL-xbrl-contexts[ fn:count( xbrli:entity/xbrli:segment/xbrldi:typedMember) = 0 and fn:count( xbrli:entity/xbrli:segment/xbrldi:explicitMember) = 0 and fn:count( xbrli:scenario/xbrldi:typedMember) = 0 and fn:count( xbrli:scenario/xbrldi:explicitMember) = 0]"/>
								<xsl:for-each select="$XBRL/xbrli:xbrl/us-gaap:NetIncomeLoss[ some $altova:context in $altova:xbrl-contexts-201522752 satisfies @contextRef = $altova:context/@id ]">
									<xsl:variable name="altova:current-xbrl-item" select="."/>
									<xsl:variable name="altova:current-xbrl-concept" select="."/>
									<altova:Context altova:ContextId="{@contextRef}" altova:Value="{.}"/>
								</xsl:for-each>
							...
							<altova:Pos altova:sLabel="Revenues">
								<xsl:variable name="altova:xbrl-contexts-201522904" select="$altova:XBRL-xbrl-contexts[ fn:count( xbrli:entity/xbrli:segment/xbrldi:typedMember) = 0 and fn:count( xbrli:entity/xbrli:segment/xbrldi:explicitMember) = 0 and fn:count( xbrli:scenario/xbrldi:typedMember) = 0 and fn:count( xbrli:scenario/xbrldi:explicitMember) = 0]"/>
								<xsl:for-each select="$XBRL/xbrli:xbrl/us-gaap:Revenues[ some $altova:context in $altova:xbrl-contexts-201522904 satisfies @contextRef = $altova:context/@id ]">
									<xsl:variable name="altova:current-xbrl-item" select="."/>
									<xsl:variable name="altova:current-xbrl-concept" select="."/>
									<altova:Context altova:ContextId="{@contextRef}" altova:Value="{.}"/>
								</xsl:for-each>
				...
				<br/>
				<span style="font-style:italic; ">
					<xsl:text>Demonstates use of a bar graph with two series. This is achieved by selecting both Revenues and Net Income in the Chart Wizard. The periods are of type &apos;duration&apos;, and their default labeling reflects this.</xsl:text>
				</span>
				<br/>
				<br/>
				<img style="height:3.47in; width:6.31in; " title="Revenues and Net Income">
					...
					<xsl:variable name="altova:nodeXAxisCategories">
						<xsl:for-each select="$XBRL">
							<altova:Pos altova:sLabel="Net income">
								<xsl:variable name="altova:xbrl-contexts-201522904" select="$altova:XBRL-xbrl-contexts[ fn:count( xbrli:entity/xbrli:segment/xbrldi:typedMember) = 0 and fn:count( xbrli:entity/xbrli:segment/xbrldi:explicitMember) = 0 and fn:count( xbrli:scenario/xbrldi:typedMember) = 0 and fn:count( xbrli:scenario/xbrldi:explicitMember) = 0]"/>
								<xsl:for-each select="$XBRL/xbrli:xbrl/us-gaap:NetIncomeLoss[ some $altova:context in $altova:xbrl-contexts-201522904 satisfies @contextRef = $altova:context/@id ]">
									<xsl:variable name="altova:current-xbrl-item" select="."/>
									<xsl:variable name="altova:current-xbrl-concept" select="."/>
									<altova:Context altova:ContextId="{@contextRef}" altova:Value="{.}"/>
								</xsl:for-each>
							...
							<altova:Pos altova:sLabel="Revenues">
								<xsl:variable name="altova:xbrl-contexts-201522752" select="$altova:XBRL-xbrl-contexts[ fn:count( xbrli:entity/xbrli:segment/xbrldi:typedMember) = 0 and fn:count( xbrli:entity/xbrli:segment/xbrldi:explicitMember) = 0 and fn:count( xbrli:scenario/xbrldi:typedMember) = 0 and fn:count( xbrli:scenario/xbrldi:explicitMember) = 0]"/>
								<xsl:for-each select="$XBRL/xbrli:xbrl/us-gaap:Revenues[ some $altova:context in $altova:xbrl-contexts-201522752 satisfies @contextRef = $altova:context/@id ]">
									<xsl:variable name="altova:current-xbrl-item" select="."/>
									<xsl:variable name="altova:current-xbrl-concept" select="."/>
									<altova:Context altova:ContextId="{@contextRef}" altova:Value="{.}"/>
								</xsl:for-each>
				...
				<h2>
					<span>
						<xsl:text>Dividends per Share</xsl:text>
					</span>
				</h2>
				<img style="height:3.47in; width:6.31in; " title="Dividends per Share">
					<xsl:variable name="altova:nChartWidthPx" as="xs:integer" select="606"/>
					<xsl:variable name="altova:nChartHeightPx" as="xs:integer" select="333"/>
					<xsl:variable name="altova:nodeXAxisCategories">
						<xsl:for-each select="$XBRL">
					...
					<xsl:variable name="altova:nodeXAxisSeries">
						<xsl:for-each select="$XBRL">
							<altova:Pos>
								<xsl:variable name="altova:xbrl-contexts-201522752" select="$altova:XBRL-xbrl-contexts[ fn:count( xbrli:entity/xbrli:segment/xbrldi:typedMember) = 0 and fn:count( xbrli:entity/xbrli:segment/xbrldi:explicitMember) = 0 and fn:count( xbrli:scenario/xbrldi:typedMember) = 0 and fn:count( xbrli:scenario/xbrldi:explicitMember) = 0]"/>
								<xsl:for-each select="$XBRL/xbrli:xbrl/us-gaap:CommonStockDividendsPerShareCashPaid[ some $altova:context in $altova:xbrl-contexts-201522752 satisfies @contextRef = $altova:context/@id ]">
									<xsl:variable name="altova:current-xbrl-item" select="."/>
									<xsl:variable name="altova:current-xbrl-concept" select="."/>
									<altova:Context altova:ContextId="{@contextRef}" altova:Value="{.}"/>
								</xsl:for-each>
				...
				<br/>
				<span style="font-style:italic; ">
					<xsl:text>Demonstates use of a bar graph with a single series. The periods use a custom labeling, defined in the Chart Wizard.</xsl:text>
				</span>
				<br/>
				<br/>
				<img style="height:3.47in; width:6.31in; " title="Dividends per Share">
					...
					<xsl:variable name="altova:nodeXAxisCategories">
						<xsl:for-each select="$XBRL">
							<xsl:for-each-group select="$altova:XBRL-xbrl-contexts" group-by="year-from-date(xbrli:period/xbrli:startDate)">
								...
								<xsl:variable name="altova:xbrl-contexts-201522752" select="current-group()"/>
								<xsl:for-each select="current-grouping-key()">
									<altova:Pos altova:sLabel="{.}">
										<xsl:for-each select="$altova:xbrl-contexts-201522752">
											<altova:Context altova:ContextId="{@id}"/>
										</xsl:for-each>
										<xsl:for-each-group select="$altova:xbrl-contexts-201522752" group-by="(month-from-date(xbrli:period/xbrli:startDate) + 2) idiv 3">
											<xsl:sort select="current-grouping-key()" data-type="number" order="ascending"/>
											<xsl:variable name="altova:xbrl-contexts-201522904" select="current-group()"/>
											<xsl:for-each select="current-grouping-key()">
												<altova:Pos altova:sLabel="{concat('Q', .)}">
													<xsl:for-each select="$altova:xbrl-contexts-201522904">
														<altova:Context altova:ContextId="{@id}"/>
													</xsl:for-each>
												</altova:Pos>
											</xsl:for-each>
				...
				<img style="height:3.47in; width:6.31in; " title="Dividends Paid">
					...
					<xsl:variable name="altova:nodeXAxisSeries">
						<xsl:for-each select="$XBRL">
							<altova:Pos>
								<xsl:variable name="altova:xbrl-contexts-201522752" select="$altova:XBRL-xbrl-contexts[ fn:count( xbrli:entity/xbrli:segment/xbrldi:typedMember) = 0 and fn:count( xbrli:entity/xbrli:segment/xbrldi:explicitMember) = 0 and fn:count( xbrli:scenario/xbrldi:typedMember) = 0 and fn:count( xbrli:scenario/xbrldi:explicitMember) = 0]"/>
								<xsl:for-each select="$XBRL/xbrli:xbrl/us-gaap:PaymentsOfDividends[ some $altova:context in $altova:xbrl-contexts-201522752 satisfies @contextRef = $altova:context/@id ]">
									<xsl:variable name="altova:current-xbrl-item" select="."/>
									<xsl:variable name="altova:current-xbrl-concept" select="."/>
									<altova:Context altova:ContextId="{@contextRef}" altova:Value="{.}"/>
								</xsl:for-each>
				...
				<br/>
				<span style="font-style:italic; ">
					<xsl:text>Demonstates use of a 3D bar graph. The periods are filtered so only nine-month periods are displayed.</xsl:text>
				</span>
				<br class="altova-page-break" clear="all"/>
				<h1 style="border-bottom:3px solid #009DC3; ">
					<altova:marker altova:name="toc">
				...
				<h2>
					<span>
						<xsl:text>Revenue by Region (9 months ended 2008-08-31)</xsl:text>
					</span>
				</h2>
				<img style="height:3.47in; width:6.31in; " title="Revenue per Region">
					...
					<xsl:variable name="altova:nodeXAxisCategories">
						<xsl:for-each select="$XBRL">
							<xsl:for-each select="altova:distinct-nodes( $altova:XBRL-xbrl-contexts/xbrli:period[ exists( xbrli:startDate ) ][ xbrli:startDate/text() eq &apos;2007-12-01&apos; and xbrli:endDate/text() eq &apos;2008-08-31&apos; ] )">
								<xsl:variable name="altova:xbrl-contexts-201522752" select="$altova:XBRL-xbrl-contexts[ fn:deep-equal( xbrli:period, current() ) ]"/>
								<altova:Pos>
									<xsl:for-each select="$altova:xbrl-contexts-201522752">
										<altova:Context altova:ContextId="{@id}"/>
									...
									<xsl:if test="true()">
										<xsl:variable name="altova:xbrl-contexts-201523056" select="$altova:xbrl-contexts-201522752[ some $altova:explicitMember in xbrli:entity/xbrli:segment/xbrldi:explicitMember satisfies ( fn:resolve-QName( xs:string($altova:explicitMember/@dimension), $altova:explicitMember ) eq fn:QName( &apos;http://xbrl.us/us-gaap/2008-03-31&apos;, &apos;StatementOperatingActivitiesSegmentAxis&apos; ) and fn:resolve-QName( $altova:explicitMember/text(), $altova:explicitMember ) eq fn:QName( &apos;http://www.altova.com/nanonull&apos;, &apos;Asia&apos; ) ) ]"/>
										<xsl:if test="exists( $altova:xbrl-contexts-201523056 )">
											<altova:Pos altova:sLabel="Asia">
												<xsl:for-each select="$altova:xbrl-contexts-201523056">
													<altova:Context altova:ContextId="{@id}"/>
												</xsl:for-each>
											</altova:Pos>
										</xsl:if>
										<xsl:variable name="altova:xbrl-contexts-201523208" select="$altova:xbrl-contexts-201522752[ some $altova:explicitMember in xbrli:entity/xbrli:segment/xbrldi:explicitMember satisfies ( fn:resolve-QName( xs:string($altova:explicitMember/@dimension), $altova:explicitMember ) eq fn:QName( &apos;http://xbrl.us/us-gaap/2008-03-31&apos;, &apos;StatementOperatingActivitiesSegmentAxis&apos; ) and fn:resolve-QName( $altova:explicitMember/text(), $altova:explicitMember ) eq fn:QName( &apos;http://www.altova.com/nanonull&apos;, &apos;Europe&apos; ) ) ]"/>
										<xsl:if test="exists( $altova:xbrl-contexts-201523208 )">
											<altova:Pos altova:sLabel="Europe">
												<xsl:for-each select="$altova:xbrl-contexts-201523208">
													<altova:Context altova:ContextId="{@id}"/>
												</xsl:for-each>
											</altova:Pos>
										</xsl:if>
										<xsl:variable name="altova:xbrl-contexts-201523360" select="$altova:xbrl-contexts-201522752[ some $altova:explicitMember in xbrli:entity/xbrli:segment/xbrldi:explicitMember satisfies ( fn:resolve-QName( xs:string($altova:explicitMember/@dimension), $altova:explicitMember ) eq fn:QName( &apos;http://xbrl.us/us-gaap/2008-03-31&apos;, &apos;StatementOperatingActivitiesSegmentAxis&apos; ) and fn:resolve-QName( $altova:explicitMember/text(), $altova:explicitMember ) eq fn:QName( &apos;http://www.altova.com/nanonull&apos;, &apos;USA&apos; ) ) ]"/>
										<xsl:if test="exists( $altova:xbrl-contexts-201523360 )">
											<altova:Pos altova:sLabel="USA">
												<xsl:for-each select="$altova:xbrl-contexts-201523360">
													<altova:Context altova:ContextId="{@id}"/>
												</xsl:for-each>
											</altova:Pos>
										</xsl:if>
					...
					<xsl:variable name="altova:nodeXAxisSeries">
						<xsl:for-each select="$XBRL">
							<xsl:if test="true()">
								<altova:Pos>
									<xsl:variable name="altova:xbrl-contexts-201522904" select="$altova:XBRL-xbrl-contexts[ fn:count( xbrli:entity/xbrli:segment/xbrldi:typedMember) = 0 and not( some $altova:explicitMember in xbrli:entity/xbrli:segment/xbrldi:explicitMember satisfies ( fn:resolve-QName( xs:string($altova:explicitMember/@dimension), $altova:explicitMember ) ne fn:QName( &apos;http://xbrl.us/us-gaap/2008-03-31&apos;, &apos;StatementOperatingActivitiesSegmentAxis&apos; )) ) and fn:count( xbrli:scenario/xbrldi:typedMember) = 0 and fn:count( xbrli:scenario/xbrldi:explicitMember) = 0]"/>
									<xsl:for-each select="$XBRL/xbrli:xbrl/us-gaap:SegmentReportingInformationRevenue[ some $altova:context in $altova:xbrl-contexts-201522904 satisfies @contextRef = $altova:context/@id ]">
										<xsl:variable name="altova:current-xbrl-item" select="."/>
										<xsl:variable name="altova:current-xbrl-concept" select="."/>
										<altova:Context altova:ContextId="{@contextRef}" altova:Value="{.}"/>
									</xsl:for-each>
				...
				<br/>
				<span style="font-style:italic; ">
					<xsl:text>Demonstates use of a pie chart. The breakdown by region is performed according to the &apos;Operating Activities&apos; dimension defined in the XBRL taxonomy.</xsl:text>
				</span>
			</body>
		</html>
	</xsl:variable>
	<xsl:template match="altova:toc[ @altova:name = 'toc' ]" mode="altova:generate-toc-xslt-tree">
		<altova:toc altova:design-id="{generate-id()}">
			...
			<xsl:for-each select="ancestor::html">
				<xsl:variable name="altova:current-level-id" select="generate-id( ancestor::altova:level[1] )"/>
	...
	<xsl:template name="monetaryItemType">
		<xsl:choose>
			<xsl:when test="number( . ) &gt;= 0">
				<span>
					<xsl:variable name="altova:seqContentStrings">
						<xsl:value-of select="format-number(number(number( . ) div 1000000), '###.##0,##', 'format1')"/>
					</xsl:variable>
			...
			<xsl:otherwise>
				...
				<span>
					<xsl:variable name="altova:seqContentStrings">
						<xsl:value-of select="format-number(number(number( . ) * -1 div 1000000), '###.##0,##', 'format1')"/>
					</xsl:variable>
					<xsl:variable name="sContent" select="string($altova:seqContentStrings)"/>
					<xsl:value-of select="$sContent"/>
				</span>
